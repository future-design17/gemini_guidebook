...
const tricksData = [
    ...
    },
    {
        ...
        desc: "AIの答えがピンとこない時は「他の案も出して」とお願いしたり、最初から複数の案を出してもらうのがおすすめです。",
        prompt: "北海道の3泊4日の旅行プランを考えています。\nまずは「定番の観光地巡り」「美味しいもの食べ歩き」「大自然リラックス」の3つの違うパターンの大まかな案を出してください。\nその中から私が一番気に入ったものを選ぶので、そこから詳しいスケジュールを一緒に詰めていきましょう。"
    },
    {
